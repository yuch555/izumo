    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3 bg-gradient-to-r from-emerald-50 to-teal-50 p-6 rounded-lg border border-emerald-100">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-gray-800">出雲市 財政状況</h1>
        </div>
      ...
      <Card className="hover:shadow-lg transition-shadow">
        <CardHeader>
          ...
          <CardDescription>令和5年度の財政収支状況</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <ResponsiveContainer width="100%" height={300} minWidth={400}>
              <BarChart data={revenueExpenditureData}>
                ...
                <YAxis
                  ...
                  style={{ fontSize: "11px" }}
                />
                <Tooltip formatter={(value: number) => `${value}億円`} />
                <Legend />
        ...
        <CardContent>
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            <p className="text-sm text-gray-700">
              ...
              人 | 平均給与:{" "}
              {(
                fiscalData.personnel.general_staff.total.salary_avg_100yen / 100
              ).toFixed(1)}
              万円/月
            </p>
          </div>
